module.exports=[93695,(a,b,c)=>{b.exports=a.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},50645,a=>{a.n(a.i(27572))},43619,a=>{a.n(a.i(79962))},13718,a=>{a.n(a.i(85523))},18198,a=>{a.n(a.i(45518))},62212,a=>{a.n(a.i(66114))},51433,a=>{"use strict";let b=[{slug:"welcome-to-side-curtains",title:"Welcome to Side Curtains",date:"2025-02-01",excerpt:"Why we started this little corner of the internet for lovers of post-war British roadsters.",content:`Welcome to Side Curtains — a place for people who understand that a car doesn't need to be fast, reliable, or even particularly weatherproof to bring you absolute joy.
...
Pull up a chair, have a browse, and welcome aboard. The road is open, the sun is out (for now), and the side curtains are stowed behind the seat... somewhere.`,category:"News",featured:!0},{slug:"five-excuses-for-another-parts-car",title:"Top 5 Excuses for Buying Another Parts Car",date:"2025-01-28",excerpt:"We've all been there. Here are the finest justifications known to humankind.",content:`Every British roadster enthusiast has uttered at least one of these phrases. Most of us have used all five. No judgement here.
...
If you've got a better excuse, we'd love to hear it in the forum. Bonus points if it actually worked.`,category:"Fun"},{slug:"lucas-electrics-survival-guide",title:"A Beginner's Guide to Lucas Electrics (and Prayer)",date:"2025-01-20",excerpt:"Joseph Lucas, Prince of Darkness. Here's how to keep the lights on... sometimes.",content:`There's an old joke: Why do the British drink warm beer? Because Lucas makes their refrigerators.
...
And if all else fails, there's always a torch and a long walk home. It's part of the adventure.`,category:"Technical"},{slug:"the-mg-t-series-love-letter",title:"A Love Letter to the MG T-Series",date:"2025-01-15",excerpt:"The TC, TD, and TF — the cars that started the sports car revolution.",content:`When American GIs returned home after the war, many brought something unexpected with them: a taste for small, nimble British sports cars. And more often than not, the car that had caught their eye was an MG.
...
Not bad for a car with 54 horsepower.`,category:"History"}];a.s(["blogPosts",0,b])},56643,a=>{"use strict";var b=a.i(7997),c=a.i(95936),d=a.i(51433);function e(){return(0,b.jsxs)("div",{className:"max-w-4xl mx-auto px-4 py-12",children:[(0,b.jsxs)("div",{className:"text-center mb-12",children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-brg mb-3",children:"The Blog"}),(0,b.jsx)("p",{className:"text-leather italic text-lg",children:"Stories, history, tips, and the occasional excuse for buying another parts car"}),(0,b.jsx)("div",{className:"w-16 h-1 bg-leather mx-auto mt-4 rounded"})]}),(0,b.jsx)("div",{className:"flex flex-wrap justify-center gap-2 mb-10",children:["All","News","History","Technical","Fun"].map(a=>(0,b.jsx)("span",{className:`px-4 py-2 rounded-full text-sm font-medium cursor-default transition-colors ${"All"===a?"bg-brg text-cream":"bg-cream-dark text-brg hover:bg-brg hover:text-cream"}`,children:a},a))}),(0,b.jsx)("div",{className:"space-y-8",children:d.blogPosts.map(a=>(0,b.jsxs)("article",{className:"bg-white rounded-xl shadow-md p-6 md:p-8 hover:shadow-lg transition-shadow border-l-4 border-brg",children:[(0,b.jsxs)("div",{className:"flex flex-wrap items-center gap-3 mb-3",children:[(0,b.jsx)("span",{className:"bg-cream-dark text-leather text-xs px-3 py-1 rounded-full font-medium",children:a.category}),(0,b.jsx)("span",{className:"text-sm text-leather",children:a.date}),a.featured&&(0,b.jsx)("span",{className:"bg-brg text-cream text-xs px-3 py-1 rounded-full font-semibold",children:"FEATURED"})]}),(0,b.jsx)("h2",{className:"text-2xl font-bold text-brg mb-3",children:(0,b.jsx)(c.default,{href:`/blog/${a.slug}`,className:"hover:text-brg-light transition-colors",children:a.title})}),(0,b.jsx)("p",{className:"text-foreground leading-relaxed mb-4",children:a.excerpt}),(0,b.jsx)(c.default,{href:`/blog/${a.slug}`,className:"text-brg font-semibold hover:text-brg-light transition-colors",children:"Read the full article →"})]},a.slug))}),(0,b.jsx)("div",{className:"text-center mt-12 p-8 bg-cream-dark rounded-xl",children:(0,b.jsxs)("p",{className:"text-leather italic",children:["More stories coming soon. Got a tale to tell about your British roadster?",(0,b.jsx)("br",{}),"We'd love to hear it in the"," ",(0,b.jsx)(c.default,{href:"/forum",className:"text-brg font-semibold hover:text-brg-light",children:"forum"}),"."]})})]})}a.s(["default",()=>e])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__ca7b88d8._.js.map