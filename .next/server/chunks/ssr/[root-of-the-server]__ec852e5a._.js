...
Not bad for a car with 54 horsepower.`,category:"History"}];a.s(["blogPosts",0,b])},67932,a=>{"use strict";var b=a.i(7997),c=a.i(95936),d=a.i(51433);a.i(70396);var e=a.i(73727);function f(){return d.blogPosts.map(a=>({slug:a.slug}))}async function g({params:a}){let{slug:f}=await a,g=d.blogPosts.find(a=>a.slug===f);return g||(0,e.notFound)(),(0,b.jsxs)("div",{className:"max-w-3xl mx-auto px-4 py-12",children:[(0,b.jsx)(c.default,{href:"/blog",className:"inline-block text-brg font-medium hover:text-brg-light transition-colors mb-8",children:"← Back to Blog"}),(0,b.jsxs)("article",{children:[(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex flex-wrap items-center gap-3 mb-4",children:[(0,b.jsx)("span",{className:"bg-cream-dark text-leather text-xs px-3 py-1 rounded-full font-medium",children:g.category}),(0,b.jsx)("span",{className:"text-sm text-leather",children:g.date})]}),(0,b.jsx)("h1",{className:"text-4xl font-bold text-brg mb-4",children:g.title}),(0,b.jsx)("div",{className:"w-16 h-1 bg-leather rounded"})]}),(0,b.jsx)("div",{className:"prose prose-lg max-w-none",children:g.content.split("\n\n").map((a,c)=>{if(a.startsWith("**")&&a.endsWith("**"))return(0,b.jsx)("h3",{className:"text-xl font-bold text-brg mt-8 mb-2",children:a.replace(/\*\*/g,"")},c);if(a.startsWith("**")){let d=a.split("**");return(0,b.jsxs)("p",{className:"text-foreground leading-relaxed mb-4",children:[(0,b.jsx)("strong",{className:"text-brg",children:d[1]}),d[2]]},c)}return/^\d\./.test(a)?(0,b.jsx)("p",{className:"text-foreground leading-relaxed mb-2 pl-4",children:a},c):(0,b.jsx)("p",{className:"text-foreground leading-relaxed mb-4",children:a},c)})})]}),(0,b.jsx)("div",{className:"mt-12 pt-8 border-t border-cream-dark",children:(0,b.jsxs)("div",{className:"bg-cream-dark rounded-xl p-6 text-center",children:[(0,b.jsx)("p",{className:"text-leather italic mb-3",children:"Enjoyed this? Got thoughts? Come chat about it."}),(0,b.jsx)(c.default,{href:"/forum",className:"inline-block px-6 py-2 bg-brg text-cream font-bold rounded-lg hover:bg-brg-light transition-colors",children:"Join the Discussion"})]})})]})}a.s(["default",()=>g,"generateStaticParams",()=>f])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__ec852e5a._.js.map